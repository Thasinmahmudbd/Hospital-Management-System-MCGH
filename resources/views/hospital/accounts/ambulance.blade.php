...
@section('page_type','Ambulance Transactions')
...
@section('content')
                ...
                <form action="{{url('/account/ambulance/log/entry')}}" class="content_container patient_info_form" method="post">
                    @csrf
                    ...
                    <div class="patient_form_element_one_is_to_one">
                        ...
                        <div class="patient_form_element">
                            ...
                            <label for="ambulance_info" class="label">Ambulance Info</label>
                            <input type="text" class="input"  name="ambulance_info" placeholder="Enter Ambulance Info" required>

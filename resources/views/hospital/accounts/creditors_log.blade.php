...
@section('page_type','Creditors Log')
...
<form action="{{url('/accounts/creditors/log/filter/')}}" method="post" class="span_hidden_bar content_container_bg_less_thin center_element">
@csrf
    ...
    <span></span>
        ...
        @if(Session::get('from')!='none')
            ...
            <div class="patient_form_element_three_is_to_one">
                ...
                <form class="text_right" action="{{url('/account/creditor/log/')}}" method="get">
                @csrf
                    <input type="submit" name="" value="Show All" class="btn_less btn text_link">
                </form>
